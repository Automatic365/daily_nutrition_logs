# App Parse Blocks — Complete

Source: `daily_log.md`
Scope: one parse block per logged day. Uses explicit `App Parse Block` when present, otherwise inferred from day content.

- Total logged days: 86
- Explicit App Parse Blocks: 45
- Inferred App Parse Blocks: 41
...
```text
Status: Pass (contained deviation)
Weight: 168.8 lbs
Abdomen (navel): ~32.0–32.2" (low of ~31.7" mid-week)
+2": null
Below: null
Sleep: 6:50 (Fair)
Calories: null
...
Daily Adherence Score: null
Boss Mode: none
Boss Name: null
Boss Outcome: none

[Inferred from daily entry: no explicit App Parse Block found.]
```

## 2026-01-21 — Wednesday (Handover to Thu 2026-01-22)

```text
Status: Pass (fast completed successfully) ✅
Weight: null
Abdomen (navel): null
+2": null
Below: null
...
```text
Status: Pass (Firm Mode; structure drift noted)
Weight: ~165.1 lb
Abdomen (navel): ~32.2″
+2": null
Below: null
...
```text
Status: Pass (one contained slip)
Weight: 164.1 lb
Abdomen (navel): null
+2": null
Below: null
...
```text
Status: Fail (below target, controlled)
Weight: 163.3 lbs
Abdomen (navel): 31.53" (new floor)
+2": null
Below: null
Sleep: ~7 hrs
Calories: null
...
```text
Status: Pass (successful Tier 1 day)
Weight: null
Abdomen (navel): null
+2": null
Below: null
...
Daily Adherence Score: Fail (contained)
Boss Mode: none
Boss Name: null
Boss Outcome: none
...
```text
Status: Fail (planned, controlled)
Weight: null
Abdomen (navel): null
+2": null
Below: null
...
```text
Status: Pass (contained, successful)
Weight: 165.3 lb
Abdomen (navel): null
+2": null
Below: null
...
Daily Adherence Score: 94% (above 90% threshold)
Boss Mode: none
Boss Name: null
Boss Outcome: none
...
```text
Status: Fail (controlled leakage)
Weight: 164.6 lb
Abdomen (navel): 32.64"
+2": 31.54"
Below: null
